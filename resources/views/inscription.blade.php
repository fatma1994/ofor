...
<body class="single-courses-page">
    ...
    <div class="container">
            ...
            <div class="col-8 row">
                ...
                <form accept="" class="form-horizontal" id="form" method="POST">
                    ...
                    <label>Frais_inscription</label>
                     <input type="text" name="montant" id=""  autofocus class="form-control">
                     <label>Date</label>
                      <input type="date" name="date" id=""  autofocus class="form-control">
      ...
      <script type='text/javascript' src="{{asset('js/app.js')}}"></script>pt>
